data=load("../phases.txt");
%data=load("../phi3vdp0.5K.txt");
phi1=data(:,1);
phi2=data(:,2);
phi3=data(:,3);
Dphi1=data(:,4);
...
C1=real(C);
%save /home/kasia/PycharmProjects/oscillators/matlab/C.txt C1
...
coeff=real(coeff);
save coeff_real_mat2.txt coeff
coeff;
...
[Qcoef1, Qcoef2, Qcoef3]=co_fcpltri(phi1, phi2, phi3, Dphi1, Dphi2, Dphi3, 2);
